...
Для управления моделью автомобиля с помощью смартфона требуется установить мобильное приложение Bluetooth.\
Такое приложение для Android можно скачать, например здесь:\
